...
def process_chunk(
    ...
    # ⚡ Bolt Optimization: Using split('\n') instead of splitlines() avoids
    # Universal Newlines overhead for a measurable speedup. We pop the last
    # empty string to match splitlines() behavior.
